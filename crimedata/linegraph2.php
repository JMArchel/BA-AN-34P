<?php 
  require_once 'connection.php';
     ...
     $query = "SELECT MONTHNAME(date) as monthname, COUNT(case_id) as totalnumber FROM cases GROUP BY MONTH(date)";
...
<head>
  ...
  <body>
    <h3><center> Number of Crimes Each Month </center></h3>
    <div id="curve_chart" style="width: 600px; height: 300px">
    </div>
  </body>
</html>