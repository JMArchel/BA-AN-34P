/**
 * This function handles showing the statistics on the UI, purely just handling the
 * php/html template.
 */
function showStats() {
  //hide the stats
  ...
  r_r.innerHTML =
    Math.round(
      (game_choices.properties.cond_count[game_choices.ROCK][
        game_choices.ROCK
      ] /
        game_choices.properties.count[game_choices.ROCK]) *
        100
    ) + "%";
  r_p.innerHTML =
    Math.round(
      (game_choices.properties.cond_count[game_choices.PAPER][
        game_choices.ROCK
      ] /
        game_choices.properties.count[game_choices.ROCK]) *
        100
  ...
  r_s.innerHTML =
    Math.round(
      (game_choices.properties.cond_count[game_choices.SCISSOR][
        game_choices.ROCK
      ] /
        game_choices.properties.count[game_choices.ROCK]) *
        100
  ...
  p_r.innerHTML =
    Math.round(
      (game_choices.properties.cond_count[game_choices.ROCK][
        ...
        game_choices.properties.count[game_choices.PAPER]) *
        100
    ) + "%";
  p_p.innerHTML =
    Math.round(
  ...
  s_r.innerHTML =
    Math.round(
      (game_choices.properties.cond_count[game_choices.ROCK][
        ...
        game_choices.properties.count[game_choices.SCISSOR]) *
        100
    ) + "%";
  s_p.innerHTML =
    Math.round(
